...
export default async function DroppedReportPage() {
  ...
  return (
    <SimpleStudentReportClient
      breadcrumbLabel="Dropped Student"
      programName={program?.program_name ?? "BS Tourism Management"}
      students={students}
      filename="dropped-students"
      title="Dropped Students"
      emptyMessage="No students are currently marked as dropped."
